...
namespace LTKJ.DataBase
{
    ...
    public abstract class SqlDbHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                if (ConfigurationManager.ConnectionStrings["SqlConnection"] != null)
        ...
        public static bool Exists(string connString, string cmdText, params SqlParameter[] cmdParams)
        {
            object obj = SqlDbHelper.GetSingle(connString, cmdText, cmdParams);
            int cmdresult;
        ...
        /// <param name="cmdParams">查询语句参数</param>
        /// <returns>返回结果</returns>
        public static object GetSingle(string connString, string cmdText, params SqlParameter[] cmdParams)
        {
        ...
        /// <param name="cmdParams">查询语句参数</param>
        /// <returns>返回结果</returns>
        public static DataSet Query(string connString, CommandType cmdType, string cmdText, params SqlParameter[] cmdParams)
        {
            using (SqlConnection connection = new SqlConnection(connString))
            {
        ...
        /// <param name="cmdParams">查询语句参数</param>
        /// <returns>返回结果</returns>
        public static DataTable GetDataTable(string connString, CommandType cmdType, string sqlText, params SqlParameter[] cmdParams)
        {
            DataTable dt = new DataTable();
            SqlDataReader dr = ExecuteReader(connString, cmdType, sqlText, cmdParams);
        ...
        /// <returns>返回结果</returns>
        public static int ExecuteNonQuery(string connString, CommandType cmdType, string cmdText, bool isTrans, params SqlParameter[] cmdParams)
        {
            int val = 0;
            if (isTrans)
            {
        ...
        public static SqlDataReader RunProcedure(string connString, string storedProcName, IDataParameter[] parameters)
        {
